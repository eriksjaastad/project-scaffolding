...
The hardcoded paths weren't subtle — they were in plain sight. But when you're focused on logic and security, you don't think to grep for your own username. Automation catches what humans forget to look for.
