...
- [x] Consulted [Local Model Learnings](Documents/reference/LOCAL_MODEL_LEARNINGS.md) (date: Jan 10, 2026)
...
3. **After any failure:** Ask "Was this preventable?" If a documented learning was ignored, log it in [Local Model Learnings](Documents/reference/LOCAL_MODEL_LEARNINGS.md) → Learning Debt Tracker

**This is a [learning-loop-pattern](../../../../writing/Documents/patterns/learning-loop-pattern.md) test.** Document the outcome regardless of success/failure.

---

## Related Documentation

- [PRE_COMMIT_HOOK_PROMPTS_INDEX](PRE_COMMIT_HOOK_PROMPTS_INDEX.md) - Index for hook prompts.
- [learning-loop-pattern](../../../../writing/Documents/patterns/learning-loop-pattern.md) - Design for the learning loop.
- [Local Model Learnings](Documents/reference/LOCAL_MODEL_LEARNINGS.md) - Local model knowledge base.
