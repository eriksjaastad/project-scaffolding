...
- [ ] Write README with quick start
  ...
  - Risk: 1 (docs only)
  - Score: 2.0 → Tier 3 ✅
  - **Instructions:** "README sections: 1. Project name/description, 2. Installation (link to .agent/rules/), 3. Quick start (3 commands), 4. License"
...
The Hologram project used multi-model review for Phase 1 planning documents (see `hologram/.agent/archives/reviews/`):
...
- Collect all responses in `.agent/archives/reviews/` directory
