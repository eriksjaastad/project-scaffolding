...
Projects exist because they're **interesting**, not because they're profitable. The goal is to explore, discover, and understand — not to monetize.
...
1. **Domain-level patterns** — What can we learn about *this* specific thing?  
   (trading signals, image workflows, news sentiment, etc.)

2. **Meta-level patterns** — What can we learn about *building projects*?  
...
- Let projects be **experiments** — data tells you what works
...
### On Maintenance
- **Consolidate on the 3rd duplicate** — first two teach you the pattern
- **Tests are for fragile parts** — parsing, grading, data integrity
- **Documentation goes stale** — archive aggressively (12 months for sessions, 3 months for misc)
- **Safety systems are scars** — you learn what needs protection by breaking it first

### On Exploration
- **We're explorers, not founders** — the journey is the point
- **Patterns at two levels** — domain + meta
- **The grind is where you learn** — projects born from necessity are the best teachers
- **Show the full picture** — AI collaborators (and humans) connect better with context

### On Data
- **Collect before deciding** — gut instincts need validation
- **Let the data change your mind** — be willing to kill features after testing
- **Measure what matters** — not just "did it run?" but "did it help?"
...
1. **Let Trading Co-Pilot run 30 days** — collect data, see what models/patterns work
2. **Complete Cortana Layer 2** — query interface and pattern detection
3. **Build 1-2 more deep projects** — more patterns will emerge
4. **Extract the scaffolding** — when you can't ignore the repeating patterns anymore
5. **Create `project-scaffolding/` with templates** — the real product ✅ **STARTED!**
